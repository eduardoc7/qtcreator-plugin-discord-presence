...
constexpr char GLOBAL_DRPC_CONTROL_MENU_ID[] = "QtCreatorDRPC.Menu";
constexpr char GLOBAL_DRPC_CONTROL_MENU_START_ACTION_ID[] =
    "QtCreatorDRPC.Action.Start";
constexpr char GLOBAL_DRPC_CONTROL_MENU_STOP_ACTION_ID[] =
    "QtCreatorDRPC.Action.Stop";
...
class Q_DECL_EXPORT QtCreatorDRPCPlugin : public ExtensionSystem::IPlugin {
  ...
  Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QtCreatorPlugin" FILE
                        "CuteDiscordPresence.json")

protected:
  struct RichPresenceFileDescriptor {
    QString ImageKey;    // The key of the art asset stored in the rich
                         // presence developer portal used for this file.
    QString Description; // Description of the file type, e.g. C++ Source
                         // File, Python Script, QMake Project File, etc...
    QString WorkingVerb; // Verb used when referring to this file, e.g.
                         // editing, designing, configuring.
  };

  // Maps the mime types of files as QStrings, to their respective
  // RichPresenceFileDescriptor.
  static const QMap<QString, RichPresenceFileDescriptor>
      mimeTypeToRpcFileDescriptorMap;

  class MimeOverrider {
  public:
    static QMap<QString, QList<QPair<QList<QString>, QString>>> MimeOverrideMap;
    static QString OverrideMimeIfApplicable(const QString &mime,
